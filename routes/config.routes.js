...
router.route('/sitetwo')
    .get(configController.viewSiteTwo)
    .post(configController.addSiteTwo)
    .put(configController.editSiteTwo);
router.route('/sitetwo/:id')
    .get(configController.sitetwoById)
    .delete(configController.deleteSiteTwo);
